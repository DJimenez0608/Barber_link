...
class ServicesComerceModel extends ChangeNotifier {
  ...
  void showAddServiceDialog(BuildContext context) {
    _showServiceDialog(context, 'Agregar Servicio', (
      nombre,
      precio,
      duracion,
    ) async {
  ...
  void showEditServiceDialog(BuildContext context, ServiciosComercio service) {
    _showServiceDialog(context, 'Modificar Servicio', (
      nombre,
      precio,
      duracion,
    ) async {
      await FirebaseFirestore.instance
          .collection('services')
          .doc(service.id)
          .update({'nombre': nombre, 'precio': precio, 'duracion': duracion});
      fetchServices();
    }, service: service);
  }
